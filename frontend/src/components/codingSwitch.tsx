    ...
    <>
      <div className="flex items-center m-auto mt-5 select-none">
        ...
        >
          ...
          <span className="absolute top-1/2 start-0.5 -translate-y-1/2 h-8 w-25 rounded-full shadow-xs transition-transform duration-200 ease-in-out peer-checked:translate-x-full bg-white"></span>
          (//Left Text)
      ...
      {decoding ? <BinaryDecoder /> : <BinaryEncoder />}
    </>
  );
}
